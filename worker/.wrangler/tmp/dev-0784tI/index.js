...
// .wrangler/tmp/bundle-S4idzi/strip-cf-connecting-ip-header.js
    ...
    const response = await fetch(
      "https://places.googleapis.com/v1/places:searchNearby",
      {
        ...
        headers: {
          ...
          "X-Goog-FieldMask": "places.id,places.displayName,places.location,places.rating,places.userRatingCount,places.priceLevel,places.regularOpeningHours.openNow,places.formattedAddress,places.primaryType,places.types,places.photos"
        },
  ...
  try {
    ...
    const response = await fetch(
      `https://places.googleapis.com/v1/places/${placeId}?languageCode=zh-TW`,
      {
        headers: {
          "X-Goog-Api-Key": apiKey,
          "X-Goog-FieldMask": "id,displayName,location,rating,userRatingCount,priceLevel,regularOpeningHours,formattedAddress,primaryType,nationalPhoneNumber,websiteUri,photos"
        }
      }
    );
    if (!response.ok) {
...
function mapGoogleTypeToOurType(primaryType, types) {
  const directMap = {
    restaurant: "restaurant",
    cafe: "cafe",
    coffee_shop: "cafe",
  ...
  const attractionTypes = /* @__PURE__ */ new Set([
    "tourist_attraction",
    "museum",
    "art_gallery",
    "park",
  ...
  const foodTypes = /* @__PURE__ */ new Set([
    "restaurant",
    "bakery",
    "bar",
    "food",
...
__name(mapGoogleTypeToOurType, "mapGoogleTypeToOurType");
...
__name(mapPriceLevel, "mapPriceLevel");
var src_default = app;
...
// .wrangler/tmp/bundle-S4idzi/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-S4idzi/middleware-loader.entry.ts
